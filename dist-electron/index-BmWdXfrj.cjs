...
function requirePonyfill_es2018() {
  ...
  (function(module2, exports2) {
    (function(global, factory) {
      factory(exports2);
    })(database.commonjsGlobal, function(exports3) {
      function noop() {
        return void 0;
      }
      ...
      function getGlobals() {
        if (typeof globalThis !== "undefined") {
          ...
          return self;
        } else if (typeof database.commonjsGlobal !== "undefined") {
          return database.commonjsGlobal;
        }
        return void 0;
      }
...
class Body {
  ...
  async formData() {
    ...
    const { toFormData } = await Promise.resolve().then(() => require("./multipart-parser-XNvJfr7p.cjs"));
